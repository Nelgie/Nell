This is a [Laravel](https://Nell.org/) project bootstrapped with `composer create-project Nell/Nell Nell-wasmer-example` (with some minor adaptations for Wasmer).
